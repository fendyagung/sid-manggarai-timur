<x-layouts.admin>
    <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-100">
        ...
        <form action="{{ route('dashboard.beritas.store') }}" method="POST" enctype="multipart/form-data"
            class="p-8 space-y-8">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <select name="is_published" id="is_published" required
                            class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-blue-500 outline-none transition-all">
                            <option value="1" {{ old('is_published', '1') == '1' ? 'selected' : '' }}>Publikasikan
                            </option>
                            <option value="0" {{ old('is_published') == '0' ? 'selected' : '' }}>Simpan sebagai Draft
                            </option>
                        </select>
                ...
                <div>
                    ...
                    <p class="text-[10px] text-slate-400 mt-2 italic" id="berita-photo-name">Format: JPG, JPEG, PNG
                        (Maks 5MB)</p>
