            ...
            <form action="{{ route('dashboard.potensi.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        @endif
                        <div class="space-y-2">
                            <label for="nama_potensi"
                                class="block text-sm font-bold text-slate-700 dark:text-slate-300">Nama Potensi /
                                Produk</label>
                            <input type="text" id="nama_potensi" name="nama_potensi" required
                                placeholder="Contoh: Kopi Colol"
                        ...
                        <div class="space-y-2">
                            <label for="kategori"
                                class="block text-sm font-bold text-slate-700 dark:text-slate-300">Kategori</label>
                    ...
                    <div class="space-y-2">
                        <label for="deskripsi"
                            class="block text-sm font-bold text-slate-700 dark:text-slate-300">Deskripsi
                            Ringkas</label>
                        <textarea id="deskripsi" name="deskripsi" rows="4" required
                            placeholder="Jelaskan keunikan potensi ini..."
                            class="w-full px-5 py-3 rounded-2xl border border-slate-200 dark:border-slate-600 dark:bg-slate-700 dark:text-white focus:ring-4 focus:ring-emerald-500/10 focus:border-[#064e3b] transition-all outline-none"></textarea>
                    ...
                    <div class="space-y-2">
                        ...
                        <div
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="text-slate-500 dark:text-slate-400" id="filename-display">Klik untuk unggah
                                    foto utama</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4 pt-4 border-t border-slate-100 dark:border-slate-700">
                        ...
                        <div id="photo-inputs" class="space-y-4">
                            <div class="flex flex-col gap-2">
                                ...
                                <div id="gallery-name-0" class="text-[10px] text-slate-400 font-bold px-2">Belum ada file dipilih</div>
                            </div>
                        </div>
                    </div>
                </div>
